...
const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
  ...
  return (
    ...
    >
      <div onClick={(e) => e.stopPropagation()} className="relative max-w-md w-full bg-card rounded-lg shadow-lg p-8 my-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label className="block text-sm font-body text-foreground mb-2">Nome Completo</label>
            <input
              type="text"
              name="fullName"
          ...
          <div>
            <label className="block text-sm font-body text-foreground mb-2">Numero di Telefono</label>
            <input
              type="tel"
              name="phone"
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-body text-foreground mb-2">Ora</label>
              <div className="relative">
          ...
          <div>
            <label className="block text-sm font-body text-foreground mb-2">Numero di Persone</label>
            <div className="relative">
          ...
          <div>
            <label className="block text-sm font-body text-foreground mb-2">Richieste Speciali</label>
            <textarea
